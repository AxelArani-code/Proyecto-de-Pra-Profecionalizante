...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="nav navbar-nav ml-auto">
          ...
          <li class="nav-item" role="presentation"><a class="nav-link" href="logout.php">Series</a></li>
  ...
  <section>
    <div class="container-fluid mx-auto text-center row mx-5-md-n-0 ">
      ...
      <figure class="snip1527">
        <div class="image"><img src="./assets/img/series/El_ltimo_baile_Miniserie_de_TV-389158062-large.jpg"
            alt="pr-sample23" /></div>
        <figcaption>
