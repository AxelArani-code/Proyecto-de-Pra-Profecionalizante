...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="nav navbar-nav ml-auto">
          <li class="nav-item" role="presentation"><a class="nav-link" href="Inicio.php">Peliculas</a></li>
          <li class="nav-item" role="presentation"><a class="nav-link" href="series.php">Series</a></li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"
              aria-expanded="false">Usuarios</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" role="presentation" href="reset-password.php">Cambiar contraseña</a>
  ...
  <div class="masthead-content">
    ...
    <section>
      <div class="container-fluid mx-auto text-center row mx-5-md-n-0">
        ...
        <figure class="snip1527">
          <div class="image"><img src="./assets/img/aves-de-presa-y-la-fantabulosa-emancipacion-de-harley-quinn-4k.jpg"
              alt="pr-sample24" /></div>
          <figcaption>
        ...
        <figure class="snip1527">
          <div class="image"><img src="./assets/img/bad-boys-for-life-4k.jpg" alt="pr-sample25" /></div>
          <figcaption>
